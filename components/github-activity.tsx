...
export default function GitHubActivity({ initialData }: { initialData }) {
        ...
        {hasNoData ? (
          <div className="card text-center py-12">
            ...
            <p className="text-gray-400 max-w-md mx-auto">
              Unable to fetch GitHub data. This could be due to missing
              credentials or API limitations. Please check back later.
            </p>
          </div>
        ) : (
          <>
